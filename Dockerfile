...
# Build arguments for dependency downloads.
# Keep volatile version args close to the final go build so changing COMMIT/DATE
# does not invalidate dependency layers.
ARG GOPROXY
ARG GOSUMDB
