        ...
        <div class="grid grid-cols-2 gap-4 lg:grid-cols-4">
          ...
          >
            ...
            <p class="text-2xl font-bold text-gray-900 dark:text-white">
              ⭐️{{ formatCost(stats.summary.total_cost) }}
            </p>
            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
              {{ t('admin.accounts.stats.accumulatedCost') }}
              <span class="text-gray-400 dark:text-gray-500">
                ({{ t('usage.userBilled') }}: ⭐️{{ formatCost(stats.summary.total_user_cost) }} ·
                {{ t('admin.accounts.stats.standardCost') }}: ⭐️{{
          ...
          >
            ...
            <p class="text-2xl font-bold text-gray-900 dark:text-white">
              ⭐️{{ formatCost(stats.summary.avg_daily_cost) }}
            </p>
             <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
              {{
              ...
              <span class="text-gray-400 dark:text-gray-500">
                ({{ t('usage.userBilled') }}: ⭐️{{ formatCost(stats.summary.avg_daily_user_cost) }})
              </span>
            </p>
          </div>
          ...
          <div class="card p-4">
            ...
            <div class="space-y-2">
              <div class="flex items-center justify-between">
                ...
                <span class="text-sm font-semibold text-gray-900 dark:text-white"
                  >⭐️{{ formatCost(stats.summary.today?.cost || 0) }}</span
                >
              </div>
              <div class="flex items-center justify-between">
                <span class="text-xs text-gray-500 dark:text-gray-400">{{ t('usage.userBilled') }}</span>
                <span class="text-sm font-semibold text-gray-900 dark:text-white"
                  >⭐️{{ formatCost(stats.summary.today?.user_cost || 0) }}</span
                >
              </div>
              <div class="flex items-center justify-between">
            ...
            <div class="space-y-2">
              ...
              <div class="flex items-center justify-between">
                ...
                <span class="text-sm font-semibold text-orange-600 dark:text-orange-400"
                  >⭐️{{ formatCost(stats.summary.highest_cost_day?.cost || 0) }}</span
                >
              </div>
              <div class="flex items-center justify-between">
                <span class="text-xs text-gray-500 dark:text-gray-400">{{ t('usage.userBilled') }}</span>
                <span class="text-sm font-semibold text-gray-900 dark:text-white"
                  >⭐️{{ formatCost(stats.summary.highest_cost_day?.user_cost || 0) }}</span
                >
              </div>
              <div class="flex items-center justify-between">
                <span class="text-xs text-gray-500 dark:text-gray-400">{{
          ...
          <div class="card p-4">
            ...
            <div class="space-y-2">
              ...
              <div class="flex items-center justify-between">
                <span class="text-xs text-gray-500 dark:text-gray-400">{{ t('usage.accountBilled') }}</span>
                <span class="text-sm font-semibold text-gray-900 dark:text-white"
                  >⭐️{{ formatCost(stats.summary.highest_request_day?.cost || 0) }}</span
                >
              </div>
              <div class="flex items-center justify-between">
                <span class="text-xs text-gray-500 dark:text-gray-400">{{ t('usage.userBilled') }}</span>
                <span class="text-sm font-semibold text-gray-900 dark:text-white"
                  >⭐️{{ formatCost(stats.summary.highest_request_day?.user_cost || 0) }}</span
                >
              </div>
            </div>
          </div>
      ...
      callbacks: {
        label: (context: any) => {
          ...
          if (label.includes('USD')) {
            return `${label}: ⭐️${formatCost(value)}`
          }
  ...
  scales: {
    ...
    y: {
      ...
      ticks: {
        ...
        callback: (value: string | number) => '⭐️' + formatCost(Number(value))
      },
      title: {
        display: true,
