    ...
    <div v-if="order" class="space-y-4">
      <div class="grid grid-cols-2 gap-4">
        ...
        <div v-if="order.amount !== order.pay_amount">
          ...
          <p class="text-sm font-medium text-gray-900 dark:text-white">{{ order.order_type === 'balance' ? '⭐️' : '¥' }}{{ order.amount.toFixed(2) }}</p>
        </div>
        <div>
      ...
      >
        ...
        <div class="grid grid-cols-2 gap-2 text-sm">
          <div>
            ...
            <span class="ml-1 font-medium text-red-700 dark:text-red-300">{{ order.order_type === 'balance' ? '⭐️' : '¥' }}{{ order.refund_amount.toFixed(2) }}</span>
          </div>
