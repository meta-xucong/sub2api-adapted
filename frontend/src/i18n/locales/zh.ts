export default {
  ...
  home: {
    ...
    features: {
      ...
      balanceQuota: '用多少付多少',
      balanceQuotaDesc: '按实际使用量积分计量，支持设置配额上限，团队用量一目了然。'
    },
    // 优势对比
    comparison: {
      title: '为什么选择我们？',
  ...
  keyUsage: {
    title: 'API Key 用量查询',
    subtitle: '输入您的 API Key 以查看实时消费积分数与使用状态',
  ...
  keys: {
    ...
    // 配额和有效期
    quotaLimit: '额度限制',
    quotaAmount: '额度积分数 (USD)',
    quotaAmountPlaceholder: '输入 USD 额度限制',
    quotaAmountHint: '设置此密钥可消费的最大积分数。0 = 无限制。',
    quotaUsed: '已用额度',
    reset: '重置',
  ...
  usage: {
    ...
    cacheTtlOverridden5m: '按 5m 积分计量',
    cacheTtlOverridden1h: '按 1h 积分计量',
    totalRequests: '总请求数',
    totalTokens: '总 Token',
    totalCost: '总消费',
    standardCost: '标准',
    ...
    errors: {
      ...
      categories: {
        auth: '认证失败', rate_limit: '限流', quota: '积分/订阅',
  ...
  affiliate: {
    title: '邀请返利',
    description: '邀请新用户注册，并将返利额度转入账户积分',
    yourCode: '我的邀请码',
    inviteLink: '邀请链接',
    copyCode: '复制邀请码',
    copyLink: '复制链接',
    ...
    stats: {
      rebateRate: '我的返利比例',
      rebateRateHint: '被邀请用户每次获取积分后你可获得的返利比例',
      invitedUsers: '邀请人数',
    ...
    tips: {
      ...
      line2: '被邀请用户获取积分后，你可获得 {rate} 的返利额度。',
      line3: '返利额度可随时转入账户积分。',
  ...
  redeem: {
    ...
    balanceAddedRedeem: '积分增加（兑换）',
    balanceAddedAffiliate: '积分增加（返利转入）',
  ...
  admin: {
    ...
    affiliates: {
      ...
      rebatesDescription: '查看每一笔产生返利的获取积分订单',
      transfersDescription: '查看返利额度转入账户积分的提取流水',
      errors: {
    ...
    users: {
      ...
      withdraw: '退款',
      depositAmount: '积分数',
      withdrawAmount: '退款积分数',
      withdrawAll: '全部',
      depositNotesPlaceholder: '例如：新用户注册奖励、活动获取积分、补偿获取积分等',
      withdrawNotesPlaceholder: '例如：服务问题退款、错误获取积分退回、账户注销退款等',
      notesOptional: '备注为可选项，有助于未来查账',
      amountHint: '请输入正数积分数',
      newBalance: '操作后积分',
      depositing: '获取积分中...',
      withdrawing: '退款中...',
      confirmDeposit: '确认获取积分',
      confirmWithdraw: '确认退款',
      depositSuccess: '积分发放成功',
      withdrawSuccess: '退款成功',
      failedToDeposit: '积分发放失败',
      failedToWithdraw: '退款失败',
      useDepositWithdrawButtons: '请使用获取积分/退款按钮调整积分',
      // 积分变动记录
      balanceHistory: '积分记录',
      ...
      platformOther: '其他',
      balanceHistoryTitle: '用户获取积分和并发变动记录',
      ...
      platformQuota: {
        ...
        subscriptionWarning: '此用户有活跃订阅，平台限额仅在积分（标准）模式下生效，订阅模式请求不受此限额约束。',
    ...
    groups: {
      ...
      subscription: {
        title: '订阅设置',
        type: '积分计量类型',
        typeHint: '标准积分计量从用户积分扣除。订阅模式使用配额限制。',
        typeNotEditable: '分组创建后无法修改积分计量类型。',
        standard: '标准（积分）',
        subscription: '订阅（配额）',
        dailyLimit: '每日限额（USD）',
      ...
      imagePricing: {
        ...
        modeHint: '默认关闭独立倍率时，图片积分消耗 = 图片价格 × 当前分组有效倍率；开启独立倍率后，图片积分消耗 = 图片价格 × 生图独立倍率。',
    ...
    channels: {
      ...
      form: {
        ...
        addInterval: '添加区间',
        requestTiers: '按次积分计量层级',
        imageTiers: '图片积分计量层级（按次）',
        addTier: '添加层级',
        noTiersYet: '暂无层级，点击添加配置按次积分计量价格',
        noPricingRules: '暂无定价规则，点击"添加"创建',
        perRequestPrice: '单次价格',
        perRequestPriceRequired: '按次/图片积分计量模式必须设置默认价格或至少一个积分计量层级',
        tierLabel: '层级',
        resolution: '分辨率',
        modelMapping: '模型映射',
        ...
        mappingSource: '源模型',
        mappingTarget: '目标模型',
        billingModelSource: '积分计量基准',
        billingModelSourceChannelMapped: '以渠道映射后的模型积分计量',
        billingModelSourceRequested: '以请求模型积分计量',
        billingModelSourceUpstream: '以最终模型积分计量',
        ...
        applyPricingToAccountStatsDesc: '启用后，未被自定义规则匹配的请求将使用模型定价文件中的标准价格计算账号统计积分消耗',
    ...
    subscriptions: {
      ...
      guide: {
        ...
        step1: {
          ...
          line2: '将积分计量类型设为「订阅」，配置日/周/月额度限制',
          line3: '保存分组，确保状态为「正常」',
          link: '前往分组管理'
        },
        step2: {
        ...
        tip: '提示：订阅分组下拉列表中只会显示积分计量类型为「订阅」且状态为「正常」的分组。如果没有可选项，请先到分组管理中创建。'
      }
    },
    ...
    accounts: {
      ...
      capacity: {
        windowCost: {
          blocked: '5h窗口积分消耗超限，账号暂停调度',
          stickyOnly: '5h窗口积分消耗达阈值，仅允许粘性会话',
          normal: '5h窗口积分消耗正常'
        },
        sessions: {
      ...
      openai: {
        ...
        oauthPassthroughDesc:
          '开启后，该 OpenAI 账号将自动透传请求与响应，仅替换认证并保留积分计量/并发/审计及必要安全过滤；如遇兼容性问题可随时关闭回滚。',
      ...
      anthropic: {
        ...
        apiKeyPassthroughDesc:
          '仅对 Anthropic API Key 生效。开启后，messages/count_tokens 请求将透传上游并仅替换认证，保留积分计量/并发/审计及必要安全过滤；关闭即可回滚到现有兼容链路。',
        webSearchEmulation: 'Web Search 模拟',
      ...
      quotaControl: {
        title: '配额控制',
        hint: '配置积分消耗窗口、会话限制、客户端亲和等调度控制。',
        windowCost: {
          label: '5h窗口积分消耗控制',
          hint: '限制账号在5小时窗口内的积分消耗使用',
          limit: '积分消耗阈值',
          limitPlaceholder: '50',
        ...
        cacheTTLOverride: {
          label: '缓存 TTL 强制替换',
          hint: '将所有缓存创建 token 强制按指定的 TTL 类型（5分钟或1小时）积分计量',
          target: '目标 TTL',
          targetHint: '选择积分计量使用的 TTL 类型'
        },
        customBaseUrl: {
          label: '自定义转发地址',
      ...
      billingRateMultiplier: '账号积分计量倍率',
      billingRateMultiplierHint: '0 表示不积分计量，仅影响账号积分计量',
      expiresAt: '过期时间',
    ...
    usage: {
      ...
      inputCost: '输入基础积分',
      outputCost: '输出基础积分',
      cacheCreationCost: '缓存创建基础积分',
      cacheReadCost: '缓存读取基础积分',
      ...
      failedToLoad: '加载使用记录失败',
      billingType: '积分计量类型',
      allBillingTypes: '全部积分计量类型',
      billingTypeBalance: '钱包积分',
      billingTypeSubscription: '订阅套餐',
      billingMode: '积分计量模式',
      billingModeToken: '按量',
      billingModePerRequest: '按次',
      billingModeImage: '按次(图片)',
      allBillingModes: '全部积分计量模式',
      ipAddress: 'IP',
    ...
    ops: {
      ...
      settings: {
        ...
        ignoreInsufficientBalanceErrors: '忽略积分不足错误',
        ignoreInsufficientBalanceErrorsHint: '启用后，账号积分不足（Insufficient balance）的错误将不会写入错误日志。',
        autoRefresh: '自动刷新',
        enableAutoRefresh: '启用自动刷新',
      ...
      tooltips: {
        ...
        sla: '服务等级协议达成率，排除业务限制（如积分不足、配额超限）的成功请求占比。',
    ...
    settings: {
      ...
      features: {
        ...
        affiliate: {
          title: '邀请返利',
          description: '老用户邀请新用户注册，新用户获取积分后老用户按比例获得返利额度。默认关闭。',
          enabled: '启用邀请返利',
          enabledHint: '关闭后用户菜单中的邀请页面入口隐藏、注册时忽略邀请码、新获取积分不再产生返利。已有返利额度仍可转入积分。',
          rebateRate: '全局返利比例',
          rebateRateHint: '获取积分后返给邀请人的默认比例（0-100%，例如填写 10 表示返利 10%）。',
          freezeHours: '返利冻结期（小时）',
          freezeHoursDesc: '新产生的返利将在冻结期内无法提现。0 = 不冻结。',
          durationDays: '返利有效期（天）',
          durationDaysDesc: '被邀请用户注册后多少天内的获取积分产生返利。0 = 永久有效。',
      ...
      defaults: {
        ...
        affiliateRebateRateHint: '获取积分后返给邀请人的比例（0-100%，例如填写 10 表示返利 10%）',
      ...
      gatewayForwarding: {
        ...
        anthropicCacheTTL1hInjectionHint: '开启后，对 Anthropic OAuth/Setup Token 请求体中已有的 ephemeral 缓存块强制写入 1h；响应 usage 默认按 5m 回写积分计量，账号级 TTL 积分计量设置优先。',
      ...
      purchase: {
        title: '积分/订阅页面',
        description: '在侧边栏展示“积分/订阅”入口，并在页面内通过 iframe 打开指定链接',
        enabled: '显示积分/订阅入口',
      ...
      payment: {
        ...
        maxAmount: '最高积分数',
        dailyLimit: '每日限额',
        balanceRechargeMultiplier: '积分倍率',
        balanceRechargeMultiplierHint: '用户每支付 1 CNY 可获得多少积分',
        balanceRechargePreview: '预览：1 CNY = ⭐️{usd}',
        rechargeFeeRate: '获取积分手续费率',
        rechargeFeeRateHint: '用户获取积分时额外收取的手续费百分比，0 表示不收取手续费',
        rechargeFeePreview: '预览：获取积分 100 元，手续费 {fee} 元',
        orderTimeout: '订单超时时间',
      ...
      balanceNotify: {
        ...
        thresholdPlaceholder: '输入积分数',
        rechargeUrl: '积分页面 URL',
        rechargeUrlPlaceholder: 'https://example.com/payment',
        rechargeUrlHint: '设置后邮件中将包含获取积分链接按钮',
      },
      quotaNotify: {
        title: '账号限额通知',
  ...
  purchase: {
    title: '积分/订阅',
    description: '通过内嵌页面完成积分/订阅',
    openInNewTab: '新窗口打开',
    notEnabledTitle: '该功能未开启',
    notEnabledDesc: '管理员暂未开启积分/订阅入口，请联系管理员。',
    notConfiguredTitle: '积分/订阅链接未配置',
    notConfiguredDesc: '管理员已开启入口，但尚未配置积分/订阅链接，请联系管理员。'
  },
  ...
  onboarding: {
    ...
    admin: {
      welcome: {
        title: '👋 欢迎使用 Sub2API',
        description:
          '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">Sub2API 是一个强大的 AI 服务中转平台，让您轻松管理和分发 AI 服务。</p><p style="margin-bottom: 12px;"><b>🎯 核心功能：</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>📦 <b>分组管理</b> - 创建不同的服务套餐（VIP、免费试用等）</li><li>🔗 <b>账号池</b> - 连接多个上游 AI 服务商账号</li><li>🔑 <b>密钥分发</b> - 为用户生成独立的 API Key</li><li>💰 <b>积分计量管理</b> - 灵活的费率和配额控制</li></ul><p style="color: #10b981; font-weight: 600;">接下来，我们将用 3 分钟带您完成首次配置 →</p></div>',
        nextBtn: '开始配置 🚀',
        prevBtn: '跳过'
      },
      groupManage: {
        title: '📦 第一步：分组管理',
        description:
          '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;"><b>什么是分组？</b></p><p style="margin-bottom: 12px;">分组是 Sub2API 的核心概念，它就像一个"服务套餐"：</p><ul style="margin-left: 20px; margin-bottom: 12px; font-size: 13px;"><li>🎯 每个分组可以包含多个上游账号</li><li>💰 每个分组有独立的积分计量倍率</li><li>👥 可以设置为公开或专属分组</li></ul><p style="margin-top: 12px; padding: 8px 12px; background: #f0fdf4; border-left: 3px solid #10b981; border-radius: 4px; font-size: 13px;"><b>💡 示例：</b>您可以创建"VIP专线"（高倍率）和"免费试用"（低倍率）两个分组</p><p style="margin-top: 16px; color: #10b981; font-weight: 600;">👉 点击左侧的"分组管理"开始</p></div>'
      },
      createGroup: {
        title: '➕ 创建新分组',
        description:
      ...
      groupMultiplier: {
        title: '💰 3. 费率倍数',
        description:
          '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;">设置该分组的积分计量倍率，控制用户的实际扣积分。</p><div style="padding: 8px 12px; background: #fef3c7; border-left: 3px solid #f59e0b; border-radius: 4px; font-size: 13px; margin-bottom: 12px;"><b>⚙️ 积分计量规则：</b><ul style="margin: 8px 0 0 16px;"><li><b>1.0</b> - 原价积分计量（基础积分价）</li><li><b>1.5</b> - 用户消耗 ⭐️1，扣除 ⭐️1.5</li><li><b>2.0</b> - 用户消耗 ⭐️1，扣除 ⭐️2</li><li><b>0.8</b> - 补贴模式（亏本运营）</li></ul></div><p style="font-size: 13px; color: #6b7280;">建议测试分组设置为 1.0</p></div>',
        nextBtn: '下一步'
      },
      groupExclusive: {
        title: '🔒 4. 专属分组（可选）',
      ...
      keyGroup: {
        title: '🎯 2. 选择分组',
        description:
          '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;">选择刚才配置好的分组。</p><div style="padding: 8px 12px; background: #eff6ff; border-left: 3px solid #3b82f6; border-radius: 4px; font-size: 13px; margin-bottom: 12px;"><b>📌 分组决定：</b><ul style="margin: 8px 0 0 16px;"><li>该密钥可以使用哪些账号</li><li>积分计量倍率是多少</li><li>是否为专属密钥</li></ul></div><p style="padding: 8px 12px; background: #f0fdf4; border-left: 3px solid #10b981; border-radius: 4px; font-size: 13px;"><b>💡 提示：</b>选择刚才创建的测试分组</p></div>',
        nextBtn: '下一步'
      },
      keySubmit: {
        title: '🎉 生成并复制',
    ...
    user: {
      ...
      keyGroup: {
        title: '🎯 选择分组',
        description:
          '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;">选择管理员为您分配的服务分组。</p><p style="padding: 8px 12px; background: #eff6ff; border-left: 3px solid #3b82f6; border-radius: 4px; font-size: 13px;"><b>📌 分组说明：</b><br/>不同分组可能有不同的服务质量和积分计量标准，请根据需要选择。</p></div>',
        nextBtn: '下一步'
      },
      keySubmit: {
        title: '🎉 完成创建',
  ...
  payment: {
    ...
    result: {
      ...
      failed: '支付失败',
      backToRecharge: '返回获取积分',
      viewOrders: '查看订单',
    },
    currentBalance: '当前积分',
    groupFallback: '分组 #{id}',
    rechargeAccount: '获取积分账户',
    activeSubscription: '当前订阅',
    noActiveSubscription: '暂无有效订阅',
    tabTopUp: '获取积分',
    tabSubscribe: '订阅',
    noPlans: '暂无可用订阅套餐',
    notAvailable: '获取积分功能暂未开放',
    confirmSubscription: '确认订阅',
    confirmCancel: '确定要取消此订单吗？',
    amountTooLow: '最低积分数为 {min}',
    amountTooHigh: '最高积分数为 {max}',
    amountNoMethod: '该积分数没有可用的支付方式',
    rechargeRatePreview: '当前倍率：1 CNY = ⭐️{usd}',
    refundReason: '退款原因',
    ...
    errors: {
      ...
      DAILY_LIMIT_EXCEEDED: '今日积分购买已达上限，剩余额度 {remaining}',
      ...
      INVALID_ORDER_TYPE: '仅积分订单可申请退款',
      INVALID_STATUS: '当前订单状态不允许此操作',
      BALANCE_NOT_ENOUGH: '退款积分数超过积分',
      REFUND_AMOUNT_EXCEEDED: '退款积分数超过购买积分数',
      REFUND_FAILED: '退款失败',
    },
    ...
    admin: {
      ...
      alreadyRefunded: '已退款',
      deductBalance: '扣除积分',
      deductBalanceHint: '从用户积分中扣回积分数',
      userBalance: '用户积分',
      orderAmount: '订单积分数',
      insufficientBalance: '积分不足，将扣至 ⭐️0',
