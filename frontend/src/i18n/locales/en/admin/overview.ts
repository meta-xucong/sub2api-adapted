export default {
    ...
    groups: {
      ...
      form: {
        ...
        reasoningEffortModelPlaceholder: 'Empty = all / gpt / gpt-5.5',
      ...
      openaiMessages: {
        ...
        targetModelPlaceholder: 'e.g., gpt-5.5 or gpt-6-astra',
