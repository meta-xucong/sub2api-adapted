export default {
    settings: {
      ...
      site: {
        ...
        apiBaseUrl: 'Site Origin (API and callbacks)',
        apiBaseUrlPlaceholder: 'https://api.example.com',
        apiBaseUrlHint:
          'Enter the site origin without a path, for example https://api.example.com. User-facing OpenAI/Codex/Grok endpoints show /v1; management APIs and callbacks use /api/v1. Leave empty to use the current site URL.',
        ...
        customEndpoints: {
          ...
          description: 'Add complete API base URLs for users to copy on the API Keys page. Include /v1 for OpenAI-compatible endpoints; use the actual path for other protocols.',
          itemLabel: 'Endpoint #{n}',
          name: 'Name',
          namePlaceholder: 'e.g., OpenAI Compatible',
          endpointUrl: 'Complete API Base URL',
          endpointUrlPlaceholder: 'https://api2.example.com/v1',
