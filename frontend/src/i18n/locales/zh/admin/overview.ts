export default {
    ...
    groups: {
      ...
      form: {
        ...
        reasoningEffortModelPlaceholder: '留空则全部 / gpt / gpt-5.5',
      ...
      openaiMessages: {
        ...
        targetModel: '目标模型',
        targetModelPlaceholder: '例如: gpt-5.5 或 gpt-6-astra',
