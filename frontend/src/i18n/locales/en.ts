export default {
  ...
  nav: {
    ...
    buySubscription: 'Points / Subscription',
    docs: 'Docs',
    myOrders: 'My Orders',
  ...
  auth: {
    ...
    promoCodeValid: 'Valid! You will receive ${amount} bonus points',
  ...
  dashboard: {
    ...
    addBalanceWithCode: 'Add points with a code'
  },
  ...
  keys: {
    ...
    quotaAmount: 'Quota Points Amount (USD)',
  ...
  usage: {
    ...
    imageOutputCost: 'Image Output Points',
    ...
    errors: {
      ...
      categories: {
        auth: 'Auth failed', rate_limit: 'Rate limited', quota: 'Points/Subscription',
  ...
  affiliate: {
    ...
    description: 'Invite new users and convert your rebate quota into account points',
    ...
    stats: {
      ...
      rebateRateHint: 'What you earn each time an invitee buys points',
    ...
    transfer: {
      ...
      description: 'Move available rebate quota into your account points',
      button: 'Transfer to Points',
      transferring: 'Transferring...',
      empty: 'No available rebate quota',
      success: '{amount} has been transferred to your points'
    },
    invitees: {
      title: 'Invited Users',
    ...
    tips: {
      ...
      line2: 'When invitees buy points, you receive {rate} of the point purchase as rebate quota.',
      line3: 'Transfer rebate quota to points at any time.',
  ...
  redeem: {
    title: 'Redeem Code',
    description: 'Enter your redeem code to add points or increase concurrency',
    ...
    newBalance: 'New Points',
    newConcurrency: 'New Concurrency',
    aboutCodes: 'About Redeem Codes',
    codeRule1: 'Each code can only be used once',
    codeRule2: 'Codes may add points, increase concurrency, or grant trial access',
    codeRule3: 'Contact support if you have issues redeeming a code',
    codeRule4: 'Points and concurrency updates are immediate',
    recentActivity: 'Recent Activity',
    historyWillAppear: 'Your redemption history will appear here',
    balanceAddedRedeem: 'Points Added (Redeem)',
    balanceAddedAffiliate: 'Points Added (Affiliate Transfer)',
    balanceAddedAdmin: 'Points Added (Admin)',
    balanceDeductedAdmin: 'Points Deducted (Admin)',
  ...
  profile: {
    ...
    balanceNotify: {
      title: 'Low Points Notification',
      description: 'Send email alert when account points fall below threshold',
      enabled: 'Enable Low Points Notification',
      ...
      extraEmailsHint: 'You must add and verify an email address to receive low points alerts',
  ...
  admin: {
    ...
    dashboard: {
      ...
      metricActualCost: 'By Actual Points',
      tokenUsageTrend: 'Token Usage Trend',
    ...
    affiliates: {
      ...
      rebatesDescription: 'View point purchase orders that generated affiliate rebates',
      transfersDescription: 'View affiliate quota transfers into account points',
      errors: {
      ...
      records: {
        ...
        orderAmount: 'Purchased Points',
        payAmount: 'Paid Amount',
        rebateAmount: 'Rebate Points',
        paymentType: 'Payment Method',
        orderStatus: 'Order Status',
        transferAmount: 'Transfer Points Amount',
        balanceAfter: 'Points After',
    ...
    users: {
      ...
      columns: {
        ...
        subscriptions: 'Subscriptions',
        balance: 'Points',
        balancePlatformQuota: 'Points (Platform Quota)',
        usage: 'Usage',
      ...
      insufficientBalance: 'Insufficient points',
      ...
      deposit: 'Deposit',
      withdraw: 'Withdraw',
      depositAmount: 'Deposit Points Amount',
      withdrawAmount: 'Withdraw Points Amount',
      withdrawAll: 'All',
      currentBalance: 'Current Points',
      ...
      useDepositWithdrawButtons: 'Please use deposit/withdraw buttons to adjust points',
      // Points History
      balanceHistory: 'Points History',
      balanceHistoryTip: 'Click to open points history',
      ...
      platformOther: 'Other',
      balanceHistoryTitle: 'User Points & Concurrency History',
      noBalanceHistory: 'No records found for this user',
      allTypes: 'All Types',
      typeBalance: 'Points (Redeem)',
      typeAffiliateBalance: 'Points (Affiliate Transfer)',
      typeAdminBalance: 'Points (Admin)',
      typeConcurrency: 'Concurrency (Redeem)',
      typeAdminConcurrency: 'Concurrency (Admin)',
      typeSubscription: 'Subscription',
      failedToLoadBalanceHistory: 'Failed to load points history',
      createdAt: 'Created',
      ...
      platformQuota: {
        ...
        subscriptionWarning: 'This user has an active subscription. Platform quotas only apply to points (standard) mode requests; subscription mode requests are not subject to these limits.',
    ...
    groups: {
      ...
      rateMultiplierHint: 'Points multiplier for this group (e.g., 1.5 = 150% of base points)',
      ...
      subscription: {
        ...
        type: 'Billing Type',
        typeHint:
          'Standard billing deducts from user points. Subscription mode uses quota limits instead.',
    ...
    riskControl: {
      ...
      keywordModeKeywordOnlyDesc: 'Decide using keywords only; misses are allowed without calling the API, saving upstream points.',
    ...
    accounts: {
      ...
      capacity: {
        windowCost: {
          blocked: '5h window points exceeded, account scheduling paused',
          stickyOnly: '5h window points at threshold, only sticky sessions allowed',
          normal: '5h window points normal'
        },
        sessions: {
      ...
      quotaControl: {
        title: 'Quota Control',
        hint: 'Configure points window, session limits, client affinity and other scheduling controls.',
        windowCost: {
          label: '5h Window Points Limit',
          hint: 'Limit account points usage within the 5-hour window',
      ...
      affinitySectionHint: 'Control how clients are distributed across accounts. Configure zone thresholds to points load.',
      ...
      stats: {
        totalCost: '30-Day Total Points',
        accumulatedCost: 'Accumulated points',
        standardCost: 'Standard',
        totalRequests: '30-Day Total Requests',
        totalCalls: 'Total API calls',
        avgDailyCost: 'Daily Avg Points',
        ...
        requests: 'Requests',
        tokens: 'Tokens',
        highestCostDay: 'Highest Points Day',
        ...
        todayTokens: 'Today Tokens',
        todayCost: 'Today Points',
        usageTrend: '30-Day Points & Request Trend',
    ...
    redeem: {
      ...
      types: {
        ...
        subscription: 'Subscription',
        invitation: 'Invitation',
        // Admin adjustment types (created when admin modifies user points/concurrency)
        admin_balance: 'Points (Admin)',
    ...
    announcements: {
      ...
      form: {
        ...
        conditionBalance: 'Points',
        operator: 'Operator',
        balanceValue: 'Points threshold',
    ...
    usage: {
      ...
      allGroups: 'All Groups',
      allTypes: 'All Types',
      inputCost: 'Input Points',
      outputCost: 'Output Points',
      cacheCreationCost: 'Cache Creation Points',
      cacheReadCost: 'Cache Read Points',
      inputTokens: 'Input Tokens',
      outputTokens: 'Output Tokens',
      ...
      ipAddress: 'IP',
      clickToViewBalance: 'Click to view points history',
    ...
    ops: {
      ...
      settings: {
        ...
        ignoreInsufficientBalanceErrors: 'Ignore Insufficient Points Errors',
        ignoreInsufficientBalanceErrorsHint: 'When enabled, insufficient account points errors will not be written to the error log.',
        autoRefresh: 'Auto Refresh',
        enableAutoRefresh: 'Enable auto refresh',
      ...
      tooltips: {
        ...
        sla: 'Service Level Agreement success rate, excluding business limits (e.g., insufficient points, quota exceeded).',
    ...
    settings: {
      ...
      features: {
        ...
        affiliate: {
          ...
          description: 'Existing users invite new ones; the inviter earns a percentage rebate on the invitee’s point purchases. Disabled by default.',
          enabled: 'Enable Affiliate',
          enabledHint: 'When off, the affiliate menu is hidden, the aff parameter is ignored at signup, and new point purchases generate no rebate. Existing rebate points can still be transferred.',
          rebateRate: 'Global Rebate Rate',
          rebateRateHint: 'Default percentage given back to the inviter on point purchases (0-100, e.g. 10 = 10%).',
      ...
      defaults: {
        ...
        defaultBalance: 'Default Points',
        defaultBalanceHint: 'Initial points for new users',
        affiliateRebateRate: 'Affiliate Rebate Rate',
        affiliateRebateRateHint:
          'Rebate percentage credited to inviter after point purchases (0-100%, e.g. 10 means 10%)',
      ...
      purchase: {
        title: 'Points / Subscription Page',
        description: 'Show a "Points / Subscription" entry in the sidebar and open the configured URL in an iframe',
        enabled: 'Show Points / Subscription Entry',
        enabledHint: 'Only shown in standard mode (not simple mode)',
        url: 'Points / Subscription URL',
      ...
      payment: {
        ...
        minAmount: 'Minimum Points Amount',
        maxAmount: 'Maximum Points Amount',
        dailyLimit: 'Daily Limit',
        balanceRechargeMultiplier: 'Points Multiplier',
        balanceRechargeMultiplierHint: 'How many points the user receives for each 1 CNY paid',
        balanceRechargePreview: 'Preview: 1 CNY = ⭐️{usd}',
        rechargeFeeRate: 'Points Fee Rate',
        rechargeFeeRateHint: 'Percentage of service fee charged on top of the point purchase amount, 0 means no fee',
        rechargeFeePreview: 'Preview: Buy 100 points, fee {fee}',
        ...
        balancePaymentDisabled: 'Disable Points Purchase',
        ...
        strategyLeastAmount: 'Least Daily Points Amount',
      ...
      balanceNotify: {
        title: 'Low Points Notification',
        description: 'Send email notification when user points fall below threshold',
        enabled: 'Enable Low Points Notification',
        threshold: 'Default Threshold',
        thresholdHint: 'Used when user has not set a custom value',
        thresholdPlaceholder: 'Enter amount',
        rechargeUrl: 'Points Purchase Page URL',
        rechargeUrlPlaceholder: 'https://example.com/payment',
        rechargeUrlHint: 'A points purchase button will appear in the email when set',
      },
      quotaNotify: {
      ...
      authSourceDefaults: {
        ...
        description: 'Configure per-source default points, concurrency, subscriptions, and grant rules.',
  ...
  // Points / Subscription Page
  purchase: {
    title: 'Points / Subscription',
    description: 'Buy points or purchase subscription via the embedded page',
    openInNewTab: 'Open in new tab',
    notEnabledTitle: 'Feature not enabled',
    notEnabledDesc: 'The administrator has not enabled the point purchase/subscription entry. Please contact admin.',
    notConfiguredTitle: 'Points / Subscription URL not configured',
    notConfiguredDesc:
      'The administrator enabled the entry but has not configured a point purchase/subscription URL. Please contact admin.'
  },
  ...
  onboarding: {
    ...
    admin: {
      ...
      groupMultiplier: {
        ...
        description: '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;">Set the billing multiplier to control user charges.</p><div style="padding: 8px 12px; background: #fef3c7; border-left: 3px solid #f59e0b; border-radius: 4px; font-size: 13px; margin-bottom: 12px;"><b>⚙️ Billing Rules:</b><ul style="margin: 8px 0 0 16px;"><li><b>1.0</b> - Original price (points price)</li><li><b>1.5</b> - User consumes ⭐️1, charged ⭐️1.5</li><li><b>2.0</b> - User consumes ⭐️1, charged ⭐️2</li><li><b>0.8</b> - Subsidy mode (loss-making)</li></ul></div><p style="font-size: 13px; color: #6b7280;">Recommend setting test group to 1.0</p></div>',
        nextBtn: 'Next'
      },
      groupExclusive: {
  ...
  payment: {
    ...
    creditedBalance: 'Credited Points',
    quickAmounts: 'Quick Point Amounts',
    customAmount: 'Custom Points Amount',
    ...
    orders: {
      ...
      payAmount: 'Paid',
      creditedAmount: 'Credited Points Amount',
      fee: 'Fee',
      baseAmount: 'Base Points Amount',
    ...
    result: {
      ...
      backToRecharge: 'Back to Buy Points',
      viewOrders: 'View Orders',
    },
    currentBalance: 'Current Points',
    groupFallback: 'Group #{id}',
    rechargeAccount: 'Points Account',
    activeSubscription: 'Active Subscription',
    noActiveSubscription: 'No active subscription',
    tabTopUp: 'Buy Points',
    tabSubscribe: 'Subscribe',
    noPlans: 'No subscription plans available',
    notAvailable: 'Points Purchase is currently unavailable',
    ...
    rechargeRatePreview: 'Current rate: 1 CNY = ⭐️{usd}',
    ...
    errors: {
      ...
      BALANCE_PAYMENT_DISABLED: 'Point purchases have been disabled.',
      ...
      DAILY_LIMIT_EXCEEDED: 'Daily point purchase limit reached. Remaining: {remaining}.',
      ...
      INVALID_ORDER_TYPE: 'Only points orders can request a refund.',
      INVALID_STATUS: 'The current order status does not allow this operation.',
      BALANCE_NOT_ENOUGH: 'Refund amount exceeds points.',
      REFUND_AMOUNT_EXCEEDED: 'Refund amount exceeds the purchased points amount.',
      REFUND_FAILED: 'Refund failed.',
    },
    ...
    admin: {
      ...
      avgAmount: 'Average Points Amount',
      revenue: 'Revenue',
      ...
      refundAmount: 'Refund Points Amount',
      ...
      deductBalance: 'Deduct Points',
      deductBalanceHint: 'Subtract credited points from user points',
      userBalance: 'User Points',
      orderAmount: 'Order Points Amount',
      insufficientBalance: 'Insufficient points — will deduct to ⭐️0',
      noDeduction: 'Will NOT deduct user points',
      forceRefund: 'Force refund (ignore points check)',
      ...
      dashboardDesc: 'Points order analytics and insights',
      daySuffix: 'd',
