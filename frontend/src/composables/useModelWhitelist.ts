...
const openaiPresetMappings = [
  ...
  { label: 'GPT-5.4 Mini', from: 'gpt-5.4-mini', to: 'gpt-5.4-mini', color: 'bg-orange-100 text-orange-700 hover:bg-orange-200 dark:bg-orange-900/30 dark:text-orange-400' },
  { label: 'GPT-5.4 Nano', from: 'gpt-5.4-nano', to: 'gpt-5.4-nano', color: 'bg-lime-100 text-lime-700 hover:bg-lime-200 dark:bg-lime-900/30 dark:text-lime-400' },
